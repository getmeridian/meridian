...
export const translations: Record<string, Record<string, string>> = {
  ru: {
    ...
    'builder.field.sni.hint': 'Сайт, который Reality имитирует. По умолчанию: www.cloudflare.com. Используйте meridian scan для оптимальных целей.',
  ...
  fa: {
    ...
    'builder.field.sni.hint': 'سایتی که Reality جعل می‌کند. پیش‌فرض: www.cloudflare.com.',
  ...
  zh: {
    ...
    'builder.field.sni.hint': 'Reality 伪装的网站。默认：www.cloudflare.com。使用 meridian scan 寻找最佳目标。',
