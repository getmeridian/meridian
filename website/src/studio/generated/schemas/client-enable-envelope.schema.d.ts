...
/**
 * Envelope schema for `meridian client enable --json`.
 */
export type ClientEnableOutputEnvelope = _ClientEnableSuccessEnvelope | _ClientEnableTerminalEnvelope;
export type Command = "client.enable";
...
export type Command1 = "client.enable";
...
export interface _ClientEnableSuccessEnvelope {
  command: Command;
...
export interface _ClientEnableTerminalEnvelope {
  command: Command1;
  data: EmptyData;
