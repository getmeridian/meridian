...
/**
 * Envelope schema for `meridian --json relay list`.
 */
export type RelayListOutputEnvelope = _RelayListSuccessEnvelope | _RelayListTerminalEnvelope;
export type Command = "relay.list";
...
export type Command1 = "relay.list";
...
export interface _RelayListSuccessEnvelope {
  command: Command;
  data: RelayListResult;
...
export interface _RelayListTerminalEnvelope {
  command: Command1;
  data: EmptyData;
