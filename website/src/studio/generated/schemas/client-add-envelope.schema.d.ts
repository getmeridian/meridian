...
/**
 * Envelope schema for `meridian client add --json`.
 */
export type ClientAddOutputEnvelope = _ClientAddSuccessEnvelope | _ClientAddTerminalEnvelope;
export type Command = "client.add";
...
export type Command1 = "client.add";
...
export interface _ClientAddSuccessEnvelope {
  command: Command;
  data: ClientAddResult;
...
export interface _ClientAddTerminalEnvelope {
  command: Command1;
  data: EmptyData;
