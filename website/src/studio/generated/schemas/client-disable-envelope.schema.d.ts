...
/**
 * Envelope schema for `meridian client disable --json`.
 */
export type ClientDisableOutputEnvelope = _ClientDisableSuccessEnvelope | _ClientDisableTerminalEnvelope;
export type Command = "client.disable";
...
export type Command1 = "client.disable";
...
export interface _ClientDisableSuccessEnvelope {
  command: Command;
  data: ClientStatusResult;
...
export interface _ClientDisableTerminalEnvelope {
  command: Command1;
  data: EmptyData;
