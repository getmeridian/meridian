 ...
 */
export type ApiSchemaOutputEnvelope = _ApiSchemaSuccessEnvelope | _ApiSchemaTerminalEnvelope;
export type Command = "api.schema";
...
export type Command1 = "api.schema";
...
export interface _ApiSchemaSuccessEnvelope {
  command: Command;
...
export interface _ApiSchemaTerminalEnvelope {
  command: Command1;
  data: EmptyData;
