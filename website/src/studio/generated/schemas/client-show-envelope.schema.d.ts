 ...
 */
export type ClientShowOutputEnvelope = _ClientShowSuccessEnvelope | _ClientShowTerminalEnvelope;
export type Command = "client.show";
...
export type Command1 = "client.show";
...
export interface _ClientShowTerminalEnvelope {
  command: Command1;
  data: EmptyData;
